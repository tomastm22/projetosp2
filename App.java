...
public class App {
    ...
    //O método main deve ser publico para poder ser executado   
    public static void main(String[] args) throws Exception {
      ...
      // Todos os capítulos forão criados sem informar as escolhas no primeiro momento.
        ...
        PARTE_1.adicionarEscolha(new Escolha("Lucas", PARTE_2));
        PARTE_1.adicionarEscolha(new Escolha("Mia", PARTE_3));
        PARTE_2.adicionarEscolha(new Escolha("direita", PARTE_5));
        PARTE_2.adicionarEscolha(new Escolha("esquerda", PARTE_4));
        PARTE_3.adicionarEscolha(new Escolha("esquerda", PARTE_6));
        PARTE_3.adicionarEscolha(new Escolha("direita", PARTE_7));
